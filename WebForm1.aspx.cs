    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            catch(Exception ex)
            {
                ...
                // Example: Log the exception to a file or display an error message to the user
        ...
        private string FetchTextFromImage2(string imagePath2)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Example: Console.WriteLine("Error fetching text from image: " + ex.Message);
                return string.Empty; // Or throw the exception if appropriate for your application flow
            }
        }
